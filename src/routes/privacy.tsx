					...
					<div className="legal-prose">
						<section>
							...
							<p>
								...
								), which may include your name, email address, and profile picture.
							</p>
							...
							<h3>Location Data</h3>
							<p>
								With your permission, we access your device's location to calculate
								travel times to parks and to show nearby parks in the Discover
								feature. Location data is used only in real-time and is not stored
								on our servers.
							</p>

							<h3>Support Communications</h3>
							<p>
								When you contact support or submit feedback, we collect your email
								address and the content of your message to respond to your inquiry.
							</p>
						</section>
						...
						<section>
							...
							<h3>Google Maps</h3>
							<p>
								Park data, photos, and directions. Google receives location queries
								when you use travel time or discovery features. See{" "}
								<a
							...
							<h3>Convex</h3>
							<p>
								Database and backend services. Your park list and activity data is
								stored on Convex servers. See{" "}
								<a
							...
							<p>
								Anonymous page view analytics. No personal data is collected. See{" "}
								<a
						...
						<section>
							...
							<p>
								We retain your account data and usage history for as long as your
							...
							<p>
								Support tickets are retained for 2 years for quality assurance and
								to help with recurring issues.
							</p>
						</section>
						...
						<section>
							...
							<p>
								...
								material changes by posting the updated policy on the Service or by
