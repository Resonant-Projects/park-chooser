		...
		<div className="landing-container">
			...
			<section className="landing-section">
				<div className="glass-card-accent">
					...
					>
						Pick a Park is a simple tool that helps families get outside more often.
						Instead of debating which park to visit or defaulting to the same spot every
						time, let us pick for you.
					</p>
					<p
						style={{
							color: "var(--color-mist)",
					...
					>
						Add your favorite local parks to your list, hit the button, and discover
						where your next adventure awaits. Track your visits and make sure you're
						exploring all your neighborhood has to offer.
					</p>
				</div>
			</section>
			...
			<section className="landing-section">
				...
				>
					...
					>
						...
						— a collection of thoughtfully designed tools and creative works at the
						intersection of technology, art, and everyday life.
					</p>
					<p
						style={{
							color: "var(--color-mist)",
					...
					>
						We believe in building things that bring a little more joy and spontaneity
						into the world.
					</p>
					<a
						href="https://resonantprojects.art"
