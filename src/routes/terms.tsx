				...
				<div className="glass-card-accent">
					<div className="legal-prose">
						<section>
							...
							<p>
								By accessing or using Pick a Park ("the Service"), you agree to be
						...
						<section>
							...
							<p>
								Pick a Park is a web application that helps users discover and track
								visits to local parks. The Service includes features for managing
								park lists, random park selection, and visit tracking.
							</p>
						</section>
						...
						<section>
							...
							<p>
								...
								(such as park notes or custom names). By using the Service, you
								grant us a license to store and display this content as necessary to
						...
						<section>
							...
							<p>
								...
								(for payment processing). Your use of these services is subject to
						...
						<section>
							...
							<p>
								...
								do not guarantee the accuracy of park information, availability of
								the Service, or that the Service will meet your specific needs. Park
								conditions, hours, and amenities may change without notice.
							</p>
						</section>
						...
						<section>
							...
							<p>
								...
								from your use of the Service. Our total liability shall not exceed
						...
						<section>
							...
							<p>
								...
								reason at our discretion. You may terminate your account at any time
						...
						<section>
							...
							<p>
								...
								<Link to="/help">our support page</Link>.
							</p>
						</section>
					</div>
				</div>
