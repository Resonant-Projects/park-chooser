...
const faqs = [
	{
		...
		answer: "You can add parks in two ways: use the Discover feature to find nearby parks automatically, or manually add parks by name and location from the Manage page. Each park you add will be available for random selection.",
	},
	{
		question: "Why doesn't the same park repeat?",
		answer: "Pick a Park uses smart selection to ensure variety in your park visits. Once you've visited all parks in your list, the cycle resets so you can explore them all again. This helps you discover and revisit all your favorite spots.",
	},
	{
		question: "How is travel time calculated?",
		answer: "Travel time is calculated using your current location (with your permission) and real-time traffic data. The estimate shows driving time under current conditions and updates when you pick a new park.",
	},
	{
		...
		<div className="landing-container">
			...
			<section className="landing-section">
				...
				<div className="glass-card-accent whisper-container">
					{faqs.map((faq, index) => (
						<div key={index} className="whisper-item" data-open={openIndex === index}>
							<button
								type="button"
