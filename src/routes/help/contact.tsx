...
function ContactPage() {
  ...
  const isValid = email.includes('@') && email.length >= 5 && message.length >= 20 && message.length <= 2000
  ...
  return (
    <div className="landing-container">
      ...
      <section className="help-hero" style={{ minHeight: '35vh' }}>
        ...
        <p
          className="subtitle"
          style={{ maxWidth: '400px', animationDelay: '0.3s' }}
        >
          We typically respond within 24-48 hours
        </p>
      </section>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-field">
              ...
              <div className="form-field-footer">
                {messageError && (
                  <span className="form-error">Message must be at least 20 characters</span>
                )}
                {messageOverLimit && (
                  <span className="form-error">Message must be less than 2000 characters</span>
                )}
